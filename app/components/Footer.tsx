export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white mt-auto">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-white text-blue-700 font-medium rounded-md hover:bg-blue-50 transition-colors duration-200"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="pt-8 mt-8 border-t border-white flex flex-col md:flex-row justify-between items-center">
